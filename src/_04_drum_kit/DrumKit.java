...
String pict = "cymbal.jpg";
JLabel cymbal = createLabelImage(pict);
...
if(drumClicked==drumLabelWithImage) {		// 16. If they clicked on the drumImage...
playSound("drum.wav");
}	
else {
